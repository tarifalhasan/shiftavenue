...
const MissionVisionMobile = () => {
  return (
    <div className=" container pb-16 overflow-hidden lg:hidden">
      <div className="grid  grid-cols-1 md:gap-32 gap-24  overflow-hidden ">
        <div>
          <div className=" text-center pb-2">
            <span className="title block uppercase">jobs</span>
            <h2 className="md:text-[45px] text-[32px] ">Mission and Vision</h2>
          </div>
